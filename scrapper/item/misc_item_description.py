...
class MiscellaneousItemDescriptionScrapper(CsvScrapper):
    ...
    def __init__(self, root_url):
        super(MiscellaneousItemDescriptionScrapper, self).__init__(root_url + '/wiki/Category:Dark_Souls:_Miscellaneous_Items', 'output/misc_items.csv', ['name', 'description'])
