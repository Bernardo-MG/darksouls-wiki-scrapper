...
class EnemyLocationScrapper(CsvScrapper):
    ...
    def __init__(self):
        super(EnemyLocationScrapper, self).__init__('https://darksouls.fandom.com/wiki/Category:Dark_Souls:_Enemies', 'output/enemy_locations.csv',
                                               ['actor', 'location'])
        self.inner_parser = ListScrapper('https://darksouls.fandom.com', AsideLocationScrapper(), lambda dom: self._extract_links(dom))
