...
# -*- coding: utf-8 -*-
#
# Dark Souls Wiki Scrapper documentation build configuration file.
...
project = 'Dark Souls Wiki Scrapper'
...
texinfo_documents = [
    (master_doc, project, '%s Documentation' % project,
     ','.join(authors), project, 'A web scrapper for the Dark Souls Wiki',
     'Miscellaneous'),
]
